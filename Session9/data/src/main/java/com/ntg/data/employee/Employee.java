...
//    @TableGenerator(name = "employee_table_gen", pkColumnName = "id", valueColumnName = "gen_id", table = "employee_id_table", allocationSize = 20, initialValue = 10)
    ...
    @JsonIgnore
    @JsonManagedReference >> works on serialization not
    @JsonBackReference
...
//    private Department department;
     ...
     *     @JsonManagedReference >> designed for handling serialization
     *     @JsonBackReference >> designed for handling deserialization
     *
     *     */
}
